...
def main():
    ...
    with tf.name_scope('input') as scope:
        ...
        sequences_batch, labels_batch = gen_data.read_and_decode(data_queue, config.batch_size, config.shuffle_capacity, config.shuffle_threads, config.shuffle_min_after_dequeue)
        test_sequences_batch, test_labels_batch = gen_data.read_and_decode(test_queue, config.batch_size, config.shuffle_capacity, config.shuffle_threads, config.shuffle_min_after_dequeue)
